        ...
        <div className="flex items-start justify-between mb-8">
          <div className="flex items-center gap-4">
            {client.photo_url ? (
              ...
              <div className="w-20 h-20 rounded-full bg-gradient-to-br from-blue-400 to-purple-500 flex items-center justify-center ring-4 ring-gray-100">
            ...
            <div>
              <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-1">{client.name}</h1>
              {client.email && (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {client.medical_notes && (
              <div className="bg-white rounded-2xl shadow-sm border border-red-200 p-6 bg-red-50">
                <h2 className="text-lg font-semibold text-red-900 mb-3">Medical Notes</h2>
                <p className="text-red-800 whitespace-pre-wrap">{client.medical_notes}</p>
              </div>
            )}
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-900">{appointments.length}</p>
                </div>
                <div>
                  <p className="text-xs text-gray-500 mb-1">Total Invoices</p>
                  <p className="text-sm font-medium text-gray-900">{invoices.length}</p>
                </div>
                <div>
                  <p className="text-xs text-gray-500 mb-1">Workouts Completed</p>
                  <p className="text-sm font-medium text-gray-900">{workoutSessions.length}</p>
                </div>
              </div>
            </div>
